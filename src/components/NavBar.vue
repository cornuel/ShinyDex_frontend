<template><!-- NAVBAR -->
    <div class="fixed flex flex-col top-0 left-0 w-44 bg-gray-900 h-full shadow-lg border-r border-gray-800">
        <div class="flex items-center pl-6 h-20 border-b border-gray-800">
            <img src="https://th.bing.com/th/id/R.1f9c26302b98356fabe7edb6d22cac61?rik=c%2fyHlTf%2fvzYZ9A&riu=http%3a%2f%2fimg2.wikia.nocookie.net%2f__cb20081113222756%2fes.pokemon%2fimages%2f6%2f66%2fRayquaza.png&ehk=3cizeZvLgdwcCenuwhAF3QqXkYrnQI9%2f3RjFA8THMBE%3d&risl=&pid=ImgRaw&r=0"
                alt="" class="rounded-full h-10 w-10 flex items-center justify-center mr-3 border-2 border-blue-500">
            <div class="ml-1">
                <p class="ml-1 text-md font-medium tracking-wide truncate text-gray-100 font-sans">{{ data.userStore.getUser
                }}</p>
                <div class="badge">
                    <span
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-6 space-y-1">
                ...
                <li>
                    <a @click="fetchAllPkmns()"
                        class="cursor-pointer relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                ...
                <li>
                    <a href="#" data-dropdown-toggle="dropdownDefaultRadio"
                    ...
                    <div id="dropdownDefaultRadio"
                        ...
                        <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <!-- <li v-for="filter in filter_types" :key="filter" @click="() => filterTypes(filter)">
                                <div class="flex items-center">
                                    <input id="default-radio-1" type="radio" value="" name="default-radio"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    <label for="default-radio-1"
                                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ capitalized(filter) }}</label>
                                </div>
                            </li> -->
                        </ul>
                    </div>
                ...
                <li>
                    <a @click="fetchUserPkmns()"
                        class="cursor-pointer relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 15 17"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="#"
                        ...
                        <span v-on:click="userSignOut"
                            class="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Logout</span>
                    </a>
                </li>
            </ul>
        </div>
...
export default {
    ...
    // },
    // mounted() {
    //     // fetchAllPkmns when arriving on the dashboard
    //     this.fetchAllPkmns()
    // }
}
</script>