<template>
  <!-- POKEMON -->
  <div
    class="p-10 left-44 absolute grid bg-indigo-300 grid-cols-1 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-6 gap-5 max-w-fit">
    <!-- <div>
            {{data.userPkmns}}
          </div>
          <div>
    ...
    <div v-for="pkmn in data.allPkmns" :key="pkmn"
